...
path_list *dir_browser = NULL;
		/* The list which stores the directory names visited in a linear manner,
		 * where the pointer current points to the current directory. */
...
#define WITHORSANS(help) ""
	...
	add_to_sclist(MMOST, "Enter", KEY_ENTER, do_enter, -2);
