...
/* The node of path_list dir_browser which stores the path names visited in directory mode in a linear doubly linked list. */
typedef struct path_list_node {
	char *name;
...
/* The path_list dir_browser which stores path names so that we can move forward and backwards. */
typedef struct path_list {
	path_list_node *head;
		/*Head of the list. */
	path_list_node *current;
		/* Current position displayed i.e. the current directory we are in. */
}path_list;
